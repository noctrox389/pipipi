...
function onUpdate(elapsed)
	...
	if (getMouseX('camHUD') > 1102 and getMouseX('camHUD') < 1280) and (getMouseY('camHUD') > 582.5 and getMouseY('camHUD') < 720 and mousePressed('left')) or keyPressed('space') and allowHeal == true then
